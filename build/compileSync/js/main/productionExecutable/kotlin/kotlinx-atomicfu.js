(function (factory) {
  ...
  protoOf(AtomicRef).ki = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).li = function () {
  ...
  protoOf(AtomicBoolean).mi = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).li = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).ni = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).li = function () {
    return this.kotlinx$atomicfu$value;
  };
